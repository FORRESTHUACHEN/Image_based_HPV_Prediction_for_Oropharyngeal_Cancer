...
trainset=tf.data.TFRecordDataset(filenames=['./TFRecords/Trainuncombatrunning0_0.tfrecords'])
...
testset=tf.data.TFRecordDataset(filenames=['./TFRecords/Testuncombatrunning0_0.tfrecords'])
